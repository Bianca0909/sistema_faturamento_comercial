...
public class TelaCadastroFuncionarioView extends JFrame {
	...
	public TelaCadastroFuncionarioView() {
		...
		JLabel lblNewLabel_6 = new JLabel("Código endereço:");
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				funcionarioDomain.setEndereco(Integer.parseInt(enderecoField.getText()));
				try {
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addComponent(funcaoField, GroupLayout.DEFAULT_SIZE, 631, Short.MAX_VALUE)
								.addComponent(codigoField, GroupLayout.PREFERRED_SIZE, 59, GroupLayout.PREFERRED_SIZE)
								.addComponent(nomeField, GroupLayout.DEFAULT_SIZE, 631, Short.MAX_VALUE)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
								...
								.addComponent(enderecoField, GroupLayout.PREFERRED_SIZE, 124, GroupLayout.PREFERRED_SIZE))
							.addContainerGap())
						.addGroup(gl_contentPane.createSequentialGroup()
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(21)
							.addComponent(enderecoField, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE)))
					.addContainerGap())
		);
	...
	public void carregarFuncionarioPorId(Integer id) {
		try {
			...
			if (funcionarioEncontrado == null) {
				...
				enderecoField.setText(Integer.toString(funcionarioEncontrado.getEndereco()));
